...
def CreateMultivariateEmdProperty(g, nmz):
    ...
    """
#     print()
#     print('-'*10, 'CreateMultivariateEmdProperty', '-'*10)
...
#     print(g.get_all_edges(0, [g.edge_index]))
#     print(g.num_edges)
...
# def CreateMultivariateSimProp(propType, emdMatsList):
...
# #     print()
#     print('-'*10, 'CreateMultivariateSimProp', '-'*10)
...
#     print('MAT SIZE----> ', matSize)
    ...
    emdMatsDict = {}
#   
#     print('LEN(emdMatsList): ', len(emdMatsList))
    ...
    for ee in g.edges():
        ...
        sourceV = g.vertex_index[ee.source()]
#         print('SourceV=',sourceV)

        targetV = g.vertex_index[ee.target()]
#         print('Ids=',(sourceV, targetV))
...
# #     print('SUM(varUsedList): ', sum(varsUsedList))
...
#         print('LEN(nmzValuesList): ', len(nmzValuesList))
...
def MakeCellLineNetwork():
    ...
    """
#     print()
#     print('-'*10, 'MakeCellLineNetwork', '-'*10)
    ...
    cellLineX = pickle.load(f1) # cell line
...
def saveDataListAndLabel(localResultsFolder, expTag, curTarg, sensValList, cellLineList):
    ...
    for pp in clinVals:
        for mm in pp: # 当前cluster中的sensVals
    ...
    import os
    saveDataLabelFolder = 'UNMZB_DataAndLabel'
...
# dataList, labelList = saveDataListAndLabel(localResultsFolder, expTag, curTarg)
...
def main(ids, curDrugs, cellLineInfoDf, AUCDf, ICDf, minNumV, ssTh, minSubSize):
    ...
    print('UNMZ End')
    print()
    return dataList, labelList, cellLineList, tissueList
