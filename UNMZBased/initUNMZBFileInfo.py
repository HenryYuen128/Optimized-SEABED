...
dataRoot = '/home/henry/code/Ensemble_Clustering/'
outputRoot = '/home/henry/code/UNMZBased/'
...
wrapperFile = list()
wrapperFile.append(dataRoot + 'drug_pairs.csv')
...
drugSensitivityFile.append([dataRoot + 'AUC.csv', 'pharmDataAUC'])
drugSensitivityFile.append([dataRoot + 'IC50.csv', 'pharmDataIC50'])
...
cellLineInfoFile.append(dataRoot + 'cell_line_info.csv')
